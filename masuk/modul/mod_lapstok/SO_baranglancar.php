...
$pdf->Cell(25.5,0.7,"LAPORAN DATA BARANG LANCAR ".date('d-m-Y H:i:s')."",0,10,'L');
$pdf->ln(0.5);
...
$tampil_barang = $db->prepare("SELECT * FROM barang ORDER BY barang.stok_barang ASC ");
...
$pdf->Output("Laporan_data_barang lancar.pdf","I");
