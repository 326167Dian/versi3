        ...
        default:
            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">Laporan Jenis Penjualan</h3>
                ...
                <div class="box-body">
                    ...
                    <form method="POST" action="modul/mod_laporan/tampil_jenispenjualan.php" target="_blank" enctype="multipart/form-data" class="form-horizontal">
            ...
            <script>
                function exportExcel(){
                    ...
                    window.open('modul/mod_laporan/lapjenispenjualan_excel.php?tipe='+tipe+'&start='+tgl_awal+'&finish='+tgl_akhir, '_blank');
                }
            </script>
            <?php
