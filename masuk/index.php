            ...
            <div class="minimal-card-wrapper">
                <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative">
                    <div class="card-body p-sm-5 text-center">
                        <img align="center" src="assets/images/mysifalogo.png" class="mb-3">
                        <h3 style="text-align:center"><b> <?= $r['satu']  ?> </b></h3>
                        
                        <form action="cek_login.php" class="w-100 mt-4 pt-2" method="post">
                            <div class="mb-4">
